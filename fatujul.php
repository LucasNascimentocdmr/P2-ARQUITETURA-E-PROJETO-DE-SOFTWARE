                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="fatujul.php">JUL</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php include('total_valores/t_emb.julh.php'); ?></th></br>
                                <th scope="col">TOTAL DE DESEMBARQUES</th>
                                <th scope="col"><?php include('total_valores/t_desem.julh.php'); ?></th>
                                </th>
                                <th scope="col">TOTAL ABASTECIDO</th>
                                <th scope="col"><?php include('total_valores/t_abas.julh.php'); ?></th>
                                </th>
                                <th scope="col">TOTAL DE VOOS</th>
                                <th scope="col"><?php include('total_valores/t_voo.julh.php'); ?></th>

                            </tr>

                            <tr>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_emb.julh.php'); ?></th></br>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_desem.julh.php'); ?></th></br>
                                <th scope="col">VALOR ABASTECIMENTO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_abas.julh.php'); ?></th></br>
                            </tr>
