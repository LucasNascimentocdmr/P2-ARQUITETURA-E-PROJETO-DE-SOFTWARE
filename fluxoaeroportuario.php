    ...
    <div class="contact">
        <div class="container">
            ...
            <div class="card text-center">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" aria-current="true" href="fluxoaeroportuario.php">Embarque - OFF SHORE</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="fluxoemav.php">Embarque - AVIAÇÃO GERAL</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col">
                    <div class="card">
                        <img src="img/Processo PAX Offshore - Embarque.png" class="card-img-top" alt="...">
