...
<head>
    <meta charset="utf-8">
    <title>Comercial - Faturamento - Omni</title>
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" aria-current="true" href="faturamento.php">JAN</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="fatudez.php">DEZ</a>
                        </li>
                        </li>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php include('total_valores/teste soma.php'); ?></th></br>
                                <th scope="col">TOTAL DE DESEMBARQUES</th>
                                <th scope="col"><?php include('total_valores/testedesembarque.php'); ?></th>
                                <th scope="col">TOTAL ABASTECIDO</th>
                                <th scope="col"><?php include('total_valores/testeabastecimento.php'); ?></th>
                                <th scope="col">TOTAL DE VOOS</th>
                                <th scope="col"><?php include('total_valores/testevoo.php'); ?></th>

                            </tr>
                            <tr>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/testevalor.php'); ?></th></br>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/testevalordesem.php'); ?></th></br>

                                <th scope="col">VALOR ABASTECIMENTO R$</th>
                                <th scope="col"><?php include('faturamento_soma/testevalorabast.php'); ?></th></br>
