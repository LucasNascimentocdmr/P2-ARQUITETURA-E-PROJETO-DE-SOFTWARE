                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="fatufev.php">FEV</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php include('total_valores/t_embarquefev.php'); ?></th>
                                <th scope="col">TOTAL DE DESEMBARQUES</th>
                                <th scope="col"><?php include('total_valores/t_desemfev.php'); ?></th>
                                <th scope="col">TOTAL ABASTECIDO</th>
                                <th scope="col"><?php include('total_valores/t_abasfev.php'); ?></th>
                                <th scope="col">TOTAL DE VOOS</th>
                                <th scope="col"><?php include('total_valores/t_voofev.php'); ?></th>

                            </tr>
                            <tr>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_embarquefev.php'); ?></th></br>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_desemfev.php'); ?></th></br>
                                <th scope="col">VALOR ABASTECIMENTO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_abasfev.php'); ?></th></br>
