...
if (isset($_GET['ID'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $atualizacao = "UPDATE passageiros SET DATA_INFO = ?, HORA_PREV = ?, HORA_REAL = ?, ORIGEM = ?, DESTINO = ?, NUM_VOO = ?, PREFIXO = ?, EMBARQUES = ?, OBSERVACOES = ?, FUNCIONARIO = ?, EMPRESA = ? WHERE ID_PASSAGEIROS = ?";
        $stmt = mysqli_prepare($mysqli, $atualizacao);
        mysqli_stmt_bind_param($stmt, "sssssssssssi", $data, $horap, $horar, $origem, $destino, $voon, $prefixo, $embarques, $observacoes, $funcionario, $empresa, $id);
    ...
    <form method="post" action="">
        <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control" id="empresa" name="empresa" value="<?php echo $dados['empresa']; ?>">
                            <option value="---------">----------</option>
