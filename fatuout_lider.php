...
<body>
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active " href="fatuout_lider.php">OUT</a>
                        </li>
                        <li class="nav-item">
  ...
  <div class="row">
    <table class="table">
      ...
      <tbody>
        <tr>
          <td><?php include('total_valores/t_emb.out_lider.php'); ?></td>
          <td><?php
              $conn = mysqli_connect("localhost", "u942302018_admin_lucas", "Codemar2023@", "u942302018_passanger");
              $resultado = mysqli_query($conn, "SELECT SUM(EMBARQUES * 38.00) AS total FROM passageiros WHERE DATA_INFO >= '2023-10-01' AND DATA_INFO <= '2023-10-31' AND empresa = 'lider_aviacao' ");
              $linhas = mysqli_fetch_array($resultado);
              echo $linhas['total'];
              ?></td>
          <td><?php include('total_valores/t_desem.out_lider.php'); ?></td>
          <td><?php include('faturamento_soma/v_desem.out_lider.php'); ?></td>
          <td><?php include('total_valores/t_abas.out_lider.php'); ?></td>
          <td><?php include('faturamento_soma/v_abas.out_lider.php'); ?></td>
          <td><?php include('total_valores/t_voo.out_lider.php'); ?></td>
          <td></td>
        </tr>
      </tbody>
    </table>
