...
<body>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link active" href="aboutde.php">Desembarques</a>
    ...
    <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
        ...
        <tbody>
            ...
            <?php include 'consulta_passageiros.php'; ?>
        </tbody>
    </table>
    ...
    $(document).ready(function() {
        var table = $('#example').DataTable({
            ...
            columnDefs: [
                {
                    targets: 0, // A coluna "DATA DAS INFORMAÇÕES" está na primeira posição (índice 0)
     ...
     <style>
            .linha-vermelha {
                background-color: #ffcccc !important;  /* Vermelho claro em formato hexadecimal */
                /* background-color: rgb(255, 204, 204) !important;  Vermelho claro em formato RGB */
                /* background-color: lightcoral !important;  Vermelho claro usando o nome da cor */
            }
