                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link active" href="fatujun.php">JUN</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php include('total_valores/t_emb.jun.php'); ?></th></br>
                                <th scope="col">TOTAL DE DESEMBARQUES</th>
                                <th scope="col"><?php include('total_valores/t_desem.jun.php'); ?></th>
                                </th>
                                <th scope="col">TOTAL ABASTECIDO</th>
                                <th scope="col"><?php include('total_valores/t_abas.jun.php'); ?></th>
                                </th>
                                <th scope="col">TOTAL DE VOOS</th>
                                <th scope="col"><?php include('total_valores/t_voo.jun.php'); ?></th>

                            </tr>

                            <tr>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_emb.jun.php'); ?></th></br>
                                <th scope="col">VALOR FATURADO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_desem.jun.php'); ?></th></br>
                                <th scope="col">VALOR ABASTECIMENTO R$</th>
                                <th scope="col"><?php include('faturamento_soma/v_abas.jun.php'); ?></th></br>
                            </tr>
